...
from .views.data_source import DS_List_View, DS_View, DS_Create_View, DS_Update_View
...
urlpatterns = [
	...
	url(r'^datasource/new$', login_required(DS_Create_View.as_view()), name='data_source_new'),
	url(r'^datasource/edit/(?P<pk>\d+)$', login_required(DS_Update_View.as_view()), name='data_source_edit'),
